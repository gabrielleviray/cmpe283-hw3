0x4FFFFFFE// SPDX-License-Identifier: GPL-2.0-only
/*
...
// ###############################################
// #                                             #
// #          CMPE283 extend visibility          #
// #                                             #
// ###############################################
extern atomic64_t exit_counter_value;
extern atomic64_t exit_duration_value;
...
// #                                             #
// ###############################################
extern atomic64_t exit_numbers[69];
...
static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	u64 start_t = rdtsc();
	atomic64_inc(&exit_counter_value);
	atomic64_inc(&exit_numbers[exit_reason]);
	...
	// #############################################################
	if (exit_reason < 69){
		atomic64_inc(&exit_num[exit_reason]);
	}
	/*
	...
	if (vmx->emulation_required){
		...
		atomic64_add(rdtsc() - start_t, &exit_duration_value);
